...
const ProductSkeleton = () => {
    return (
        <div className="relative flex flex-col group w-full animate-pulse">
            {/* Image Placeholder */}
            <div className="relative w-full aspect-[4/5] overflow-hidden rounded-[24px] bg-gray-50 border border-gray-100 shadow-sm mb-4">
                {/* Simulated Glow */}
            ...
            <div className="flex flex-col px-1 w-full gap-2">
                ...
                {/* Title Row */}
                <div className="h-4 w-2/3 bg-gray-100 rounded-full mt-1" />
            </div>
        </div>
    );
};
